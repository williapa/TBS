...
Both renderers show cell selection with a solid white outline and legal targets with solid action-specific colors. The 2D target overlay is painted above units and buildings so occupied cells cannot hide any part of the outline.
