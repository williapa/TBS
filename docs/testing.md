...
- `pnpm ai:phase3:test`: Four Forests strategy priorities, canonical opening recovery, occupied-route and anti-cycle behavior, aggressive blocker handling, release-readiness statistics, and qualification-gate coverage for the Python pipeline.
