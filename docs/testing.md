...
- `pnpm nx run @TBS/renderer-2d:test`: SVG projection, accessible semantic cell/entity controls, click-disabled preview mode, legal-target overlays, team and health indicators, and movement animation markup.
